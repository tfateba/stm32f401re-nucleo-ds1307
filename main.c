...
/*
* @fn       static void ds1307InterfaceInit ( void )
* @brief   Configure the I2C Interface 1 and start the Interface
*/
static void ds1307InterfaceInit ( void )
{
...
/*
* @fn       static void serialDriver2Init ( void )
* @brief    Serial Driver Initialisation and start the interface
*/
static void serialDriver2Init ( void )
{
...
/*
* @fn           static struct ds1307_t getDs1307Date (  msg_t *status,
                                                        systime_t *tmo )
* @brief        Get Clock and Calendar
* @param[in]    *status
* @param[in]    *tmo
*/
static struct ds1307_t getDs1307Date ( msg_t *status, systime_t *tmo )
{
    struct ds1307_t dsData;
